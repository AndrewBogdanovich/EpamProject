...
@Api(
        ...
        namespace = @ApiNamespace(
                ownerDomain = "backend.myapplication.Tom.example.com",
                ownerName = "backend.myapplication.Tom.example.com",
                packagePath = ""
        )
)
public class UserEndpoint {
    ...
    @ApiMethod(
            name = "insert")
    public void insert(@Named("id") String id, @Named("name") String name, @Named("age") String age, @Named("city") String city) {
        ...
        User user = new User(Long.valueOf(id), name, age, city);
